...
keymap.set("n", "<leader>bx", "<cmd>BufferLineCloseOthers<CR>", { desc = "Close all other buffers" })
...
keymap.set("n", "<leader>bc", "<cmd>BufferLinePickClose<CR>", { desc = "Pick the buffer to close" })
